#!/usr/bin/env python3
"""rebuild_broken.py -- Scans vagas files and rebuilds broken_links.json.
Marks broken: Ashby UUID links, old Greenhouse URLs (pre-cutoff),
Greenhouse URLs for companies known to redirect to error.
"""
import re, json
...
BROKEN_GH_COMPANIES = {"remotecom", "nearform"}
